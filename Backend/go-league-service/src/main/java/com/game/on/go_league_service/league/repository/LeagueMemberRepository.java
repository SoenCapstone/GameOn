...
public interface LeagueMemberRepository extends JpaRepository<LeagueMember, Long> {
    ...
    List<LeagueMember> findByUserId(String userId);

    Optional<LeagueMember> findByLeagueIdAndUserId(UUID leagueId, String userId);
    ...
    """)
    Optional<LeagueRole> findRoleByLeagueIdAndUserId(UUID leagueId, String userId);
}