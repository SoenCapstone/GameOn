  ...
  return (
    ...
    >
      ...
      <View style={profileStyles.main}>
        ...
        <ThemedText style={profileStyles.email}>
        ...
        >
          <ThemedText style={profileStyles.editButtonText}>
            Edit Profile
          </ThemedText>
        </Pressable>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            ...
            >
              <View>
                <ThemedText style={profileStyles.leagueName}>
                  {item.name}
                </ThemedText>
                <ThemedText style={profileStyles.leagueRole}>
                  {item.role}
                </ThemedText>
              </View>
            </Pressable>
